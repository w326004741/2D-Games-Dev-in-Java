...
public class InvadersApplication extends JFrame implements Runnable, KeyListener {
    ...
    public InvadersApplication() {
        ...
        icon = new ImageIcon(workingDirectory + "/src/images/badguy.png");
    ...
    public void run() {
        while (true) {
            ...
            if (isGameInProgress) {
                ...
                // if all alien are destroy
                if (!anyAliensAlive) {
                    enemyWave++;
                    startNewWave(); // speed faster
                }
    ...
    public void keyPressed(KeyEvent e) {
        if (isGameInProgress) {
            ...
            startNewGame(); // make isGameInProcess
        }
    }
